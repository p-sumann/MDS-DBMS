...
VALUES (2, 'Krishna Prasad Jaishi', 13, 33, 'Father'),
    (3, 'Silu Poudel', 12, 2, 'Sister'),
    (4, 'Sujita Sharma', 9, 1, 'Cousin Sister'),
    (5, 'Prabin Adhikari', 14, 3, 'Cousin Brother');
   
-- update command for office
   
UPDATE office SET oname = 'Ntc_Suman_33' WHERE oname = 'Suman_Ncell_33';
